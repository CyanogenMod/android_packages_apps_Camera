...
public class HdrSoftwareRS {
     ...
     * @param resId
     */
    public HdrSoftwareRS(RenderScriptGL rs, Resources res, int resId) {
        mRS = rs;
...
//        mRS.bindRootScript(mScript);
    ...
    public void setBitmapInput(Bitmap bm_lo, Bitmap bm_mid, Bitmap bm_hi) {
        ...
        mInBitmapAlloc[BITMAP_LOW] = Allocation.createFromBitmap(mRS, bm_lo,  Allocation.MipmapControl.MIPMAP_NONE, Allocation.USAGE_GRAPHICS_TEXTURE);
        mInBitmapAlloc[BITMAP_MID] = Allocation.createFromBitmap(mRS, bm_mid, Allocation.MipmapControl.MIPMAP_NONE, Allocation.USAGE_GRAPHICS_TEXTURE);
        mInBitmapAlloc[BITMAP_HI]  = Allocation.createFromBitmap(mRS, bm_hi,  Allocation.MipmapControl.MIPMAP_NONE, Allocation.USAGE_GRAPHICS_TEXTURE);
        ...
        // and pixel depth.
	mOutBitmapAlloc = Allocation.createFromBitmap(mRS, bm_lo, Allocation.MipmapControl.MIPMAP_NONE, Allocation.USAGE_GRAPHICS_TEXTURE);
