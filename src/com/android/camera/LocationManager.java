...
public class LocationManager implements android.location.GpsStatus.Listener {
    ...
    public void recordLocation(boolean recordLocation, boolean showGpsIcon) {
        mShowGpsIcon = showGpsIcon;
    ...
    public void onGpsStatusChanged(int event) {
        ...
        switch (event) {
            ...
            case GpsStatus.GPS_EVENT_SATELLITE_STATUS:
                ...
                if (mListener != null && mRecordLocation && mShowGpsIcon) {
                    mListener.showGpsOnScreenIndicator(mHasGpsFix);
                }
                break;
        }
    }
    ...
    private class LocationListener
        ...
        public void onProviderDisabled(String provider) {
            ...
            if (mListener != null && mRecordLocation && mShowGpsIcon
                    && android.location.LocationManager.GPS_PROVIDER.equals(mProvider)) {
                mListener.showGpsDisabledOnScreenIndicator();
            }
        }
