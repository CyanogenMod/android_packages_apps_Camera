...
public class PhotoController extends PieController
    ...
    public void initialize(PreferenceGroup group) {
        ...
        ListPreference nohandsPref = group.findPreference(CameraSettings.KEY_NOHANDS_MODE);
        if (nohandsPref != null && nohandsPref.getValue() == null) {
            nohandsPref.setValue(mActivity.getString(R.string.pref_camera_nohands_default));
        }
        ...
        mOtherKeys = new String[] {
                ...
                CameraSettings.KEY_NOHANDS_MODE,
    ...
    public void resetNoHandsShutter() {
