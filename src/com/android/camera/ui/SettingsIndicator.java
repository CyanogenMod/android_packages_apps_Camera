...
public class SettingsIndicator extends AbstractIndicator {
    ...
    public SettingsIndicator(Context context, Parameters params) {
        super(context);
        mContext = context;
        mParameters = params;
        ...
        setupSlider(mSharpnessValues, params.getMaxSharpness(), params.getDefaultSharpness(),
                CameraSettings.KEY_SHARPNESS, mPreferences);
    ...
    public boolean isAvailable() {
        return !(mContrastValues.size() == 0 
                && mSaturationValues.size() == 0 
                && mSharpnessValues.size() == 0);
    }
