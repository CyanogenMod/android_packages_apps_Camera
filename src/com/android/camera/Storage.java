...
public class Storage {
    ...
    public static boolean updateImage(ContentResolver resolver, String storage, Uri uri,
...
public static String generateDirectory(String storage) {
    ...
    public static int generateBucketIdInt(String storage) {
        // Match the code in MediaProvider.computeBucketValues().
        return generateDirectory(storage).toLowerCase().hashCode();
    }
